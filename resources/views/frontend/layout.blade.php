...
{{--                    if user login show my profile and logout or user not login show signup--}}
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{route('user.order.list')}}">My Order</a>
                                    </li>
                                    <li>
...
{{--                        </li>--}}
                        @if(Auth::check())
                            @if(Auth::user()->is_registration_by === 'user')
                                ...
                                <li class="sub-mobile-menu">
                                    <a class="nav-link" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        My Profile<i class="fas fa-chevron-down float-end"></i>
                                    </a>
                                    <ul class="list-unstyled" aria-labelledby="navbarDropdown">
                                        ...
                                        <li>
                                            <a class="" href="{{route('user.order.list')}}">My Order</a>
                                        </li>
                                        <li>
                                            <form action="{{ route('logout') }}" method="POST">
                                                @csrf
                            ...
                            @else
                                <li class="nav-item sub-mobile-menu" >
                                    <a class="nav-link {{ request()->routeIs('show.signup') ? 'active' : '' }}" href="{{route('show.signup')}}">Sign Up</a>
                                </li>
                                <li class="nav-item sub-mobile-menu">
                                    <a class="nav-link {{ request()->routeIs('show.signin') ? 'active' : '' }}" href="{{route('show.signin')}}">Sign In</a>
