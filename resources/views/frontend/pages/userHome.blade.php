...
{{--                        <img src="{{asset('images/slider/'. $data->file )}}" alt="banner-img" class="w-100 img-fluid" />--}}
{{--                    </div>--}}
{{--                @endforeach--}}
                <div class="banner-item">
            ...
            <div class="service-btn text-center">
                <a href="{{route('user.order.decision')}}" class="theme-btn theme-btn-primary text-uppercase">Order Now <span class="ms-2"><i
