    ...
    <div class="leftside-menu">
        ...
        <div class="h-100" id="leftside-menu-container" data-simplebar>
            <ul class="side-nav">
                ...
                @can('order-manage')
                    <li class="side-nav-item">
                        <a data-bs-toggle="collapse" href="#sidebarPages111" aria-expanded="false" aria-controls="sidebarPages" class="side-nav-link">
                            <i class="ri-briefcase-4-line"></i>
                            <span>Order Manage</span>
                            <span class="menu-arrow"></span>
                        </a>
                        <div class="collapse" id="sidebarPages111">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="{{route('order.manage')}}">Wash Order</a>
                                </li>
                                <li>
                                    <a href="{{route('dry.order.manage')}}">Dry Cleaning Order</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                ...
                @can('dry-cleaning-service')
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#sidebarPages12" aria-expanded="false" aria-controls="sidebarPages" class="side-nav-link">
                        <i class="ri-briefcase-4-line"></i>
                ...
                @endcan
                    ...
                    <li class="side-nav-item">
                        <a data-bs-toggle="collapse" href="#sidebarPages100" aria-expanded="false" aria-controls="sidebarPages" class="side-nav-link">
                            <i class="ri-rotate-lock-line"></i>
                            <span>Account </span>
                            <span class="menu-arrow"></span>
                        </a>
                        <div class="collapse" id="sidebarPages100">
                            <ul class="side-nav-second-level">
                                <li>
