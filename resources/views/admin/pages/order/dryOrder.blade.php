            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Dry Wash Order Section!</li>
                    </ol>
                </div>
                <h4 class="page-title">Dry Wash Order Section!</h4>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <form action="{{route('dry.order.manage')}}" method="GET" class="d-flex">
                        <div class="me-2">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{route('dry.order.destroy',$orderData->id)}}" class="btn btn-danger">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
